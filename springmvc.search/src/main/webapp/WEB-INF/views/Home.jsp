...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %><!-- jstl uri library -->
<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
...
<script src="<c:url value="/resources/js/script.js" />"></script><!-- js script added -->
    
    <title>Hello, world!</title>
    
  </head>
  <body>
 <!-- <img alt="my image" src="<c:url value="/resources/image/Snapchat-604424361.jpg" />"> --> <!-- image added -->
    <div class="container">
